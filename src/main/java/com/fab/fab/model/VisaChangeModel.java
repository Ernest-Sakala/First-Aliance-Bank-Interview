...
@Entity
@Table(name = "visa_change")
public class VisaChangeModel {
    ...
    public VisaChangeModel() {
    }

    public VisaChangeModel(int id, CustomerModel customer, BranchModel branch, String changeRequest,
