...
@Entity
@Table(name = "internet_banking_change")
public class InternetBankingChangeModel {
    ...
    public InternetBankingChangeModel() {
    }

    public InternetBankingChangeModel(int id, CustomerModel customer, BranchModel branch, String changeRequest,
